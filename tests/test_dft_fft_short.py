...
def compare_dft_fft():
    ...
    # Measure DFT
    dft_result, dft_time, dft_memory = measure_memory_and_time(dft_matrix_multiplication, signal)
    ...
    fft_iterative_result, fft_iterative_time, fft_iterative_memory = measure_memory_and_time(fft_iterative, signal.f)
