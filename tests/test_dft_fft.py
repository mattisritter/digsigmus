...
def compare_methods():
    ...
    signal = generate_signal(frequency, duration, sampling_frequency)

    # Measure DFT
    _, dft_time, dft_memory = measure_memory_and_time(dft_matrix_multiplication, signal)
    ...
    _, fft_iterative_time, fft_iterative_memory = measure_memory_and_time(fft_iterative, signal_padded_iterative.f)
